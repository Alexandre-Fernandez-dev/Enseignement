...
\noindent{\bf Contrôle 3 (B) -- 55min. \hfill Première générale \hfill 20/11/2024}
...
\begin{exercice}{(5 min)}
    %Résoudre l'inéquation $3x^2 -5x + 2 \geq 0$.%suivantes :
...
\begin{exercice}{(5 min)}
    %Déterminer deux entiers naturels successifs dont le produit est égal à $54522$.
...
\begin{exercice}{(15 min)}
    ...
    \begin{center}
        %\includegraphics[width=0.6\linewidth]{functionA.png}
...
\begin{exercice}{(10 min)}
    %Donner l'unique polynôme de degré 2 passant par $A(0;\ 3), B(1;\ 5)$ et $C(-3;\ 9)$.
