% @see : https://coopmaths.fr/alea/?uuid=d02da&id=2L21-4&n=1&d=10&s=true&s2=2-7&s3=false&cd=1&tip=0&alea=BaBt&uuid=6575c&id=2N32-1&n=1&d=10&s=4&s2=true&cd=0&tip=0&alea=7jos&uuid=35d63&id=2L11-2&n=1&d=10&s=3&s2=3&s3=3&s4=3&cd=1&tip=0&alea=t8kA&v=eleve&z=1.1
...
{
  \normalsize
  \textbf{Seconde} \hfill \textbf{Contrôle Flash 1 (10 min)} \hfill \textbf{Sujet A}
}
\hrule
\vfill
...
\tcbset{mathaleaexo/.style={breakable}}
% @see : https://coopmaths.fr/alea?uuid=d02da&id=2L21-4&n=1&d=10&s=true&s2=2-7&s3=false&alea=bEEn\%3Fuuid\%3D6575c&cd=1&cols=1
\begin{EXO}{}{}
Résoudre l'équation suivante.
 ...
 $-9y+13=3$
\tcbset{mathaleaexo/.style={breakable}}
% @see : https://coopmaths.fr/alea?uuid=6575c&id=2N32-1&n=1&d=10&s=4&s2=true&alea=3Wjr\%3Fuuid\%3D35d63&cd=0&cols=4
\end{EXO}
...
\begin{multicols}{4}
 \begin{minipage}[t]{\linewidth} $A = \dfrac{4}{2} + \dfrac{9}{2} \times \dfrac{4}{8}$  \end{minipage}
\end{multicols}
\tcbset{mathaleaexo/.style={breakable}}
% @see : https://coopmaths.fr/alea?uuid=35d63&id=2L11-2&n=1&d=10&s=3&s2=3&s3=3&s4=3&alea=8ofG&cd=1&cols=1
\end{EXO}
...
{
  \normalsize
  \textbf{Seconde} \hfill \textbf{Contrôle Flash 1 (10 min)} \hfill \textbf{Sujet B}
}
\hrule
\vfill
...
\tcbset{mathaleaexo/.style={breakable}}
% @see : https://coopmaths.fr/alea?uuid=d02da&id=2L21-4&n=1&d=10&s=true&s2=2-7&s3=false&alea=BaBt&cd=1&cols=1
\begin{EXO}{}{}
Résoudre l'équation suivante.
 ...
 $8y-8=-10$
\tcbset{mathaleaexo/.style={breakable}}
% @see : https://coopmaths.fr/alea?uuid=6575c&id=2N32-1&n=1&d=10&s=4&s2=true&alea=7jos&cd=0&cols=4
\end{EXO}
...
\begin{multicols}{4}
 \begin{minipage}[t]{\linewidth} $A = \dfrac{1}{4} - \dfrac{3}{4} \times \dfrac{2}{9}$ \end{minipage}
\end{multicols}
\tcbset{mathaleaexo/.style={breakable}}
% @see : https://coopmaths.fr/alea?uuid=35d63&id=2L11-2&n=1&d=10&s=3&s2=3&s3=3&s4=3&alea=t8kA&cd=1&cols=1
\end{EXO}
