...
\begin{exercice} Écrire à l'aide d'un seul vecteur :       $\overrightarrow{HI}+\overrightarrow{IH}=$
\end{exercice}
...
\begin{multicols}{2}
 \begin{minipage}[t]{\linewidth} Construire le point $I$ tel que $\overrightarrow{GI} = \vec{u} + \vec{v}$.\\ \end{minipage}
\end{multicols}
\begin{center}
	\includegraphics[width=0.5\linewidth]{cflash_6_b.png}
\end{center}
\end{exercice}
...
\begin{exercice}
	...
	\begin{enumerate}
		\item $\overrightarrow{BO} + \overrightarrow{EA}$
		\item $\overrightarrow{AE} + \overrightarrow{DF}$
		\item $\overrightarrow{OC} - \overrightarrow{FC}$
		\item $\overrightarrow{CF} + \overrightarrow{CB} + \overrightarrow{OD}$
	\end{enumerate}
	\begin{center}
		\includegraphics[width=0.5\linewidth]{cflash_7.png}
	\end{center}
\end{exercice}
