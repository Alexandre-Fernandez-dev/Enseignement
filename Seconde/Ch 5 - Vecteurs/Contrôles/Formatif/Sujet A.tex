% @see : https://coopmaths.fr/alea/?uuid=3b7ee&id=2N41-3&n=1&d=10&s=2&s2=true&alea=ZRM1&cd=1&uuid=3d2f9&id=2N41-1&n=1&d=10&s=1&s2=3&alea=0Hm0&cd=1&uuid=55cc0&id=2N32-1&n=1&d=10&s=1&alea=Ziol&cd=1&uuid=26f3b&id=can2G10&alea=1TAO&uuid=d2b57&id=2G23-1&n=1&d=10&s=1&alea=c9LA&uuid=6cf42&id=2G21-2&alea=8BOV&v=latex
\documentclass{exam}
\usepackage{tasks}
...
\begin{exercice}
 ...
 Écrire à l'aide d'un seul vecteur :
        $\overrightarrow{EF}+\overrightarrow{FE}=$
\end{exercice}
...
\begin{multicols}{2}
 \begin{minipage}[t]{\linewidth} Construire le point $H$ tel que $\overrightarrow{EH} = \vec{u} + \vec{v}$.\\ \end{minipage}
\end{multicols}
\begin{center}
...
\begin{exercice}
	...
	\begin{enumerate}
		\item $\overrightarrow{CO} + \overrightarrow{DF}$
		\item $\overrightarrow{BE} + \overrightarrow{CF}$
		\item $\overrightarrow{OB} - \overrightarrow{EB}$
		\item $\overrightarrow{AE} + \overrightarrow{AD} + \overrightarrow{OC}$
	\end{enumerate}
	\begin{center}
