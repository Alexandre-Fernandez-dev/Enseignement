...
\begin{definition}{}{}
Un entier naturel est un nombre premier s'il admet exactement deux diviseurs positifs : \hide{1 et lui même}.
\end{definition}
...
\begin{proposition}{}{}
Tout entier naturel supérieur ou égal à 2 est divisible par \hide{un nombre premier}.
\end{proposition}
...
\begin{itemize}[noitemsep,topsep=0pt]
  ...
  \item Soit $n$ est divisible par un nombre premier compris entre \hide{2 et $\sqrt{n}$}.
\end{itemize}
\end{proposition}
...
\begin{itemize}[noitemsep,topsep=0pt]
  \item Dresser la liste de tous les nombres premiers inférieurs ou égaux à \hide{$\sqrt{n}$}.
...
\begin{itemize}[noitemsep,topsep=0pt]
  ...
  $$
  n=\hideM{p_{1}^{\beta_{1}} \times p_{2}^{\beta_{2}} \times \ldots \times p_{k}^{\beta_{k}}} \quad\left(\text { avec } 0 \leqslant \beta_{i} \leqslant \alpha_{i}, \text { pour tout } i\right)
  $$
  \item le nombre de diviseurs de $n$ est $\hideM{\left(\alpha_{1}+1\right)\left(\alpha_{2}+1\right) \ldots\left(\alpha_{k}+1\right)}$.
\end{itemize}
...
\begin{itemize}[noitemsep,topsep=0pt]
  \item $\operatorname{PGCD}(n ; m)=\hideM{p_{1}^{\min \left(\alpha_{1} \beta_{1}\right)} \times p_{2}^{\min \left(\alpha_{2} \beta_{2}\right)} \times \ldots \times p_{k}^{\min \left(\alpha_{k} \beta_{k}\right)}}$
  \item $\operatorname{PPCM}(n ; m)=\hideM{p_{1}^{\max \left(\alpha_{1} \beta_{1}\right)} \times p_{2}^{\max \left(\alpha_{2} \beta_{2}\right)} \times \ldots \times p_{k}^{\max \left(\alpha_{k} \beta_{k}\right)}}$
\end{itemize}
\end{proposition}
...
\begin{proposition}{Lemme}{}
  Si $p$ est un nombre premier et $k$ un entier tel que $1 \leqslant k \leqslant p-1$, alors $p$ divise \hide{$\dbinom{p}{k}$}.
\end{proposition}
\begin{demo}
...
\begin{proposition}{}{}
Si $p$ est un nombre premier alors pour tout entier $a, a^{p} \equiv \hideM{a[p]}$.
\end{proposition}
...
Si $p$ est un nombre premier et si $a$ est un entier non divisible par $p$, alors $a^{p-1} \equiv \hideM{1}[p]$.
\end{proposition}
