...
\noindent{\bf Contrôle 1 (A) -- 1h. \hfill Première générale -- Groupe 1 \hfill 05/11/2024}
%\vspace{5mm}
...
\begin{enumerate}
    ...
    \end{enumerate}
    \item Exprimer la somme $\sum_{k=2}^{10}(5k+1)$ sous la forme $a+b+\dots+c$.
\end{enumerate}
...
\begin{exercice}[20 min, 6 points]
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            \item Donner $s_0$, $s_1$ et $s_2$.
            \item Déterminer l'expression de $s_n$.
        \end{enumerate}

        \item On dispose de 360 cartes. Combien d'étages peut-on construire ?
    \end{enumerate}
\end{exercice}
