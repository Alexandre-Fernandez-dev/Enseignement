...
Dans tout le chapitre, on considère un espace de probabilité $\Omega$.
...
\begin{itemize}
  \item[]
  \item En général, le mot «parmi» dans un énoncé se traduit par une probabilité conditionnelle.
  \item Attention ! Les probabilités conditionnelles $\mathrm{P}_{\mathrm{A}}(\mathrm{B})$ et $\mathrm{P}_{\mathrm{B}}(\mathrm{A})$ ne sont en général pas égales.
\end{itemize}
\end{remark}
...
\begin{demo}
D'après la définition, on sait que $\mathrm{P}_{\mathrm{A}}(\mathrm{B})=\dfrac{\mathrm{P}(\mathrm{A} \cap \mathrm{B})}{\mathrm{P}(\mathrm{A})}$. Il suffit de multiplier chaque terme de cette égalité par $\mathrm{P}(\mathrm{A})$ pour obtenir le résultat souhaité.
\end{demo}
...
\begin{center}
\includegraphics[max width=0.8\textwidth]{2025_05_13_795d2fb7a2e4fd469256g-3}
\end{center}
...
\includegraphics[max width=0.5\textwidth, center]{2025_05_13_795d2fb7a2e4fd469256g-5}
...
\includegraphics[max width=0.5\textwidth, center]{2025_05_13_795d2fb7a2e4fd469256g-6}
...
\begin{proposition}{}{}
Si $\mathrm{A}$ et $\mathrm{B}$ sont deux événements indépendants, alors les événements $\mathrm{A}$ et $\overline{\mathrm{B}}$ sont également indépendants.
\end{proposition}

\begin{demo}
B et $\overline{\mathrm{B}}$ forment une partition de l'univers donc, d'après la formule des probabiltiés totales :
...
$$
\mathrm{P}(\mathrm{~A})=\mathrm{P}(\mathrm{A}) \times \mathrm{P}(\mathrm{B})+\mathrm{P}(\mathrm{A} \cap \overline{\mathrm{B}})
$$
...
$$
\mathrm{P}(\mathrm{A})(1-\mathrm{P}(\mathrm{B}))=\mathrm{P}(\mathrm{A} \cap \overline{\mathrm{B}})
$$

donc

$$
\mathrm{P}(\mathrm{A}) \mathrm{P}(\overline{\mathrm{B}})=\mathrm{P}(\mathrm{A} \cap \overline{\mathrm{B}})
$$
