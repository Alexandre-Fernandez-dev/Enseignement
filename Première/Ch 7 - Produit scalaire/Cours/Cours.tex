...
\begin{definition}{}{}
  ...
  $$
  \vv{u} \cdot \vv{v}=\hideM{\dfrac{1}{2}\left(\|\vv{u}+\vv{v}\|^{2}-\|\vv{u}\|^{2}-\|\vv{v}\|^{2}\right)}
  $$
\end{definition}

\begin{definition}{}{}
  Deux vecteurs non nuls sont dit ortogonaux si, et seulement si, $(\vv{u}, \vv{v})=\hideM{\dfrac{\pi}{2}}$ ou $(\vv{u}, \vv{v})=\hideM{-\dfrac{\pi}{2}}$
\end{definition}
...
\begin{proposition}{}{}
  $\vv{u}$ et $\vv{v}$ sont ortogonaux si, et seulement si, $\vv{u} \cdot \vv{v}=\hideM{0}$.
\end{proposition}
...
\begin{proposition}{}{}
  ...
  $$
  \vv{u} \cdot \vv{v}=\hideM{x x^{\prime}+y y^{\prime}}
  $$
\end{proposition}
...
\begin{proposition}{}{}
  ...
  $$
  \vv{u} \cdot \vv{v}=\hideM{\vv{v} \cdot \vv{u}}
  $$
\end{proposition}
...
\begin{proposition}{}{}
  ...
  \begin{itemize}
    \item $\vv{u} \cdot(\vv{v}+\vv{w})=\hideM{\vv{u} \cdot \vv{v}+\vv{u} \cdot \vv{w}}$
    \item $(k \vv{u}) \cdot \vv{v}=\hideM{\vv{u} \cdot(k \vv{v})} =\hideM{k(\vv{u} \cdot \vv{v})}$
  \end{itemize}
\end{proposition}
...
\begin{proposition}{}{}
  \begin{itemize}
    \item $\|\vv{u}+\vv{v}\|^{2}=\hideM{\|\vv{u}\|^{2}+2 \vv{u} \cdot \vv{v}+\|\vv{v}\|^{2}}$
    \item $\|\vv{u}-\vv{v}\|^{2}=\hideM{\|\vv{u}\|^{2}-2 \vv{u} \cdot \vv{v}+\|\vv{v}\|^{2}}$
    \item $(\vv{u}-\vv{v}) \cdot(\vv{u}+\vv{v})=\hideM{\|\vv{u}\|^{2}-\|\vv{v}\|^{2}}$
  \end{itemize}
\end{proposition}
...
\begin{proposition}{}{}
  \begin{itemize}[itemsep=5pt]
    \item $\vv{u} \cdot \vv{v}=\hideM{\frac{1}{2}\left(\|\vv{u}+\vv{v}\|^{2}-\|\vv{u}\|^{2}-\|\vv{v}\|^{2}\right)}$
    \item $\vv{u} \cdot \vv{v}=\hideM{\frac{1}{2}\left(\|\vv{u}\|^{2}+\|\vv{v}\|^{2}-\|\vv{u}-\vv{v}\|^{2}\right)}$
    \item $\vv{u} \cdot \vv{v}=\hideM{\frac{1}{4}\left(\|\vv{u}+\vv{v}\|^{2}-\|\vv{u}-\vv{v}\|^{2}\right)}$
  \end{itemize}
\end{proposition}
...
\begin{proposition}{}{}
  ...
  $$
  \vv{u} . \vv{v}=\hideM{\|\vv{u}\| \times\|\vv{v}\| \times \cos (\theta)}
  $$
\end{proposition}
...
\begin{demo}
  Soient deux vecteurs $\vv{u}$ et $\vv{v}$. On définit le repère orthonormé $(0 ; \vv{i}, \vv{j})$ tel que $\vv{i}=\dfrac{1}{\|\vv{u}\|} \vv{u}$ et tel que $(\vv{i} ; \vv{j})=+\dfrac{\pi}{2}$. Dans ce repère, $\vv{v}$ a pour coordonnées $\dbinom{\|\vv{v}\| \cos \theta}{\|\vv{v}\| \sin \theta}$.\\
...
\begin{proposition}{}{}
  ...
  $$
  \overrightarrow{\mathrm{AB}} \cdot \overrightarrow{\mathrm{AC}}=\hideM{\overrightarrow{\mathrm{AB}} \cdot \overrightarrow{\mathrm{AH}}}=\left\{
    \begin{array}{cl}
      \hideM{\mathrm{AB} \times \mathrm{AH}} & \text { si } \overrightarrow{\mathrm{AB}} \text { et } \overrightarrow{\mathrm{AH}} \text { sont de même sens. } \\
      \hideM{-\mathrm{AB} \times \mathrm{AH}} &
      \text { sinon }
    \end{array}\right.
    $$
  \end{proposition}
