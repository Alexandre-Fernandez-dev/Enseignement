...
\begin{itemize}
  \item $f$ est \hide{croissante} sur I si, et seulement si, $f^{\prime}$ est \hide{positive} sur I.
  \item $f$ est \hide{décroissante} sur I si, et seulement si, $f^{\prime}$ est \hide{négative} sur I.
  \item $f$ est \hide{constante} sur I si, et seulement si, $f^{\prime}$ est \hide{nulle} sur I.
\end{itemize}
\end{proposition}
...
\begin{itemize}
  \item Si $f^{\prime}$ est \hide{strictement positive} sur I sauf pour un nombre fini de réels où elle s'annule, alors $f$ est \hide{strictement croissante}.
  \item Si $f^{\prime}$ est \hide{strictement négative} sur I sauf pour un nombre fini de réels où elle s'annule, alors $f$ est \hide{strictement décroissante}.
\end{itemize}
\end{proposition}
...
On dit que $f(c)$ est un \hide{\textbf{maximum global}} sur I lorsque pour tout $x \in I, \hideM{f(x) \leqslant f(c)}$.
On dit que $f(c)$ est un \hide{\textbf{minimum global}} sur I lorsque pour tout $x \in I, \hideM{f(x) \geqslant f(c)}$.
\end{definition}

\begin{definition}{}{}
Soit I un intervalle et $c$ un réel de I . On considère une fonction $f$ définie sur I.
\begin{itemize}
  \item Dire que $f(c)$ est un \textbf{maximum local} (respectivement \textbf{minimum local}) de $f$ signifie qu'il existe un intervalle $] a ; b[$ contenant $c$ (avec $a \neq b$) et tel que pour tout $x \in] a ; b[, \hideM{f(x) \leqslant f(c)}$ (respectivement $f(x) \geqslant f(c)$).
...
\begin{itemize}
  \item Si $f(c)$ est un maximum \hide{global}, alors $f(c)$ est un maximum \hide{local}.
  \item Si $f(c)$ est un minimum \hide{global}, alors $f(c)$ est un minimum \hide{local}.
\end{itemize}
\end{proposition}
...
\begin{itemize}
  \item Si $f(c)$ est un extremum local, alors $\hideM{f^{\prime}(c)=0}$.
  \item Si $f^{\prime}$ s'annule en changeant de signes alors $f(c)$ est un \hide{extremum local} de $f$.
\end{itemize}
\end{proposition}
