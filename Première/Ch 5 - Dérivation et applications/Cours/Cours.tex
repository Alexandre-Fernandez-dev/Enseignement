...
On dit que $f(c)$ est un maximum global sur I lorsque pour tout $x \in I, f(x) \leqslant f(c)$.\\
On dit que $f(c)$ est un minimum global sur I lorsque pour tout $x \in I, f(x) \geqslant f(c)$.
\end{definition}
...
\begin{itemize}
  \item Dire que $f(c)$ est un maximum local (respectivement minimum local) de $f$ signifie qu'il existe un intervalle $] a ; b[$ contenant $c($ avec $a \neq b)$ et tel que pour tout $x \in] a ; b[, f(x) \leqslant f(c)$ (respectivement $f(x) \geqslant f(c)$ ).
  \item Un extremum local est un maximum local ou un minimum local.\\
\end{itemize}
\end{definition}
