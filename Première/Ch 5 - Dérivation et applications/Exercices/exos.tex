...
Étudier les variations de la fonction $f$ définie sur $\mathbb{R}$ par $f(x) = \frac{1}{3}x^2 - \frac{5}{2}x + 1$.
\end{exercice}
...
Étudier les variations de la fonction $f$ définie sur $\mathbb{R} \setminus \{7\}$ par $f(x) = \frac{x+1}{x-7}$.
\end{exercice}

% Exercice 13
\begin{exercice}[title=Exercice 13 $\quad \star \quad$ { [Calculer] }]{}{}
Étudier les variations de la fonction $f$ définie sur $\mathbb{R}$ par $f(x) = \frac{x}{x^2 + 1}$.
\end{exercice}

% Exercice 14
\begin{exercice}[title=Exercice 14 $\quad \star \quad$ { [Calculer] }]{}{}
Étudier les variations de la fonction $f$ définie sur $\mathbb{R} \setminus \{0\}$ par $f(x) = x - 4 + \frac{2}{x}$.
\end{exercice}

% Exercice 15
\begin{exercice}[title=Exercice 15 $\quad \star \quad$ { [Calculer] }]{}{}
Étudier les variations de la fonction $f$ définie sur $\mathbb{R}$ par $f(x) = \frac{2x^2 + 12x}{x^2 + 4}$.
\end{exercice}

% Exercice 16
\begin{exercice}[title=Exercice 16 $\quad \star \quad$ { [Calculer] }]{}{}
Étudier les variations de la fonction $f$ définie sur $[\frac{4}{3}; +\infty[$ par $f(x) = \sqrt{3x-4}$.
\end{exercice}

% Exercice 17
\begin{exercice}[title=Exercice 17 $\quad \star \star \star \quad$ { [Calculer] }]{}{}
Étudier les variations de la fonction $f$ définie sur $\mathbb{R}$ par $f(x) = \frac{x^4}{2} - \frac{2x^3}{3} + 2x^2 - 4x + 5$.
\end{exercice}

% Exercice 18
\begin{exercice}[title=Exercice 18 $\quad \star \star \quad$ { [Calculer] }]{}{}
Étudier les variations de la fonction $f$ définie sur $]-4; +\infty[$ par $f(x) = \frac{x^3 - 2}{x + 4}$.
\end{exercice}
...
On considère les fonctions $f$ et $g$ définies sur $\mathbb{R}$ par $f(x) = x^3 - 3x$ et $g(x) = x - \frac{4}{x}$. Déterminer la position relative de $C_f$ et de $C_g$.
\end{exercice}
...
\begin{enumerate}
  ...
  \item Montrer que pour tout $x \in \mathbb{R} \setminus \{1\}$, $f(x) = -2x + 1 - \frac{1}{x-1}$.
...
\begin{enumerate}
    \item (a) Représenter la situation par un arbre de probabilités.
    \item (b) Exprimer $P(M \cap T)$, $P(\overline{M} \cap T)$ puis $P(T)$ en fonction de $p$.
    \item (a) Démontrer que la probabilité de $M$ sachant $T$ est donnée par la fonction $f$ définie sur $[0; 1]$ par :
    \[
    f(p) = \frac{98p}{97p + 1}.
    \]
    \item (b) Étudier les variations de la fonction $f$.
...
\begin{enumerate}
    ...
    \end{enumerate}
    \item Déterminer algébriquement la vitesse de propagation $v(t)$. Étudier les variations de $v$ puis retrouver l'ensemble des résultats de la question 2.
\end{enumerate}
\end{exercice}
...
\begin{enumerate}
    ...
    \item Graphiquement, et pour chaque expérience, quelle est la vitesse d'apparition du composé (en mol.min$^{-1}$) à l'instant $t = 5$ min ? à $t = 60$ min ?
