...
\begin{definition}{}{}
  Soit $D$ une droite. On appelle vecteur normal à $D$ tout vecteur non nul qui est orthogonal à un vecteur directeur de $D$.
\end{definition}
...
\begin{proposition}{}{}
  ...
  (ii) Il existe un vecteur directeur de $D$ et un vecteur directeur de $D^{\prime}$ qui sont orthogonaux ;\\
  (iii) Il existe un vecteur normal à $D$ et un vecteur normal à $D^{\prime}$ qui sont orthogonaux ;
\end{proposition}
...
\begin{proposition}{}{}
  ...
  \begin{itemize}
    \item La droite d'équation cartésienne $a x+b y+c=0$ admet pour vecteur normal le vecteur $\vec{n}\dbinom{a}{b}$.
...
\begin{definition}{}{}
  On appelle cercle de centre $\Omega$ et de rayon $r$, noté $\mathcal{C}_{(\Omega, r)}$ l'ensemble des points M du plan tels que $\Omega \mathrm{M}=r$.
\end{definition}
...
\begin{proposition}{}{}
  ...
  $$
  \mathrm{M}(x ; y) \in \mathcal{C}_{(\Omega, r)} \Longleftrightarrow(x-a)^{2}+(y-b)^{2}=r^{2}
  $$
\end{proposition}
...
\begin{proposition}{}{}
  Soient A et B deux points distincts du plan. L'ensemble des points M du plan tels que $\overrightarrow{\mathrm{MA}} \cdot \overrightarrow{\mathrm{MB}}=0$ est le cercle de diamètre $[\mathrm{AB}]$.
\end{proposition}
...
\begin{proposition}{}{}
  ...
  $$
  \mathrm{M} \in \mathcal{C} \Longleftrightarrow \text { AMB est rectangle en } \mathrm{M}
  $$
\end{proposition}
...
\begin{proposition}{}{}
  ...
  $$
  a^{2}=b^{2}+c^{2}-2 b c \cos (\widehat{\mathrm{~A}})
  $$
\end{proposition}
...
\begin{proposition}{}{}
  ...
  $$
  \frac{a}{\sin (\widehat{\mathrm{~A}})}=\frac{b}{\sin (\widehat{\mathrm{~B}})}=\frac{c}{\sin (\widehat{\mathrm{C}})}
  $$
\end{proposition}
...
\begin{proposition}{}{}
Pour tout triangle $\mathrm{ABC}$, il existe un unique point $G$ tel que $\overrightarrow{\mathrm{GA}}+\overrightarrow{\mathrm{GB}}+\overrightarrow{\mathrm{GC}}=\overrightarrow{0}$. Ce point est appelé \textbf{centre de gravité} du triangle.
\end{proposition}
